    ...
    return <EuiPanel className="sql-console-query-editor container-panel" paddingSize="none">
      ...
      <div className="action-container">
        <EuiFlexGroup gutterSize="m">
          ...
          <EuiFlexItem grow={false} onClick={() => {this.updateSQLQueries(""); this.props.onClear()}}><EuiHeaderLink className="sql-editor-link" href="#" isActive>Clear</EuiHeaderLink></EuiFlexItem>
        </EuiFlexGroup>
      </div>
    </EuiPanel>;
  }
